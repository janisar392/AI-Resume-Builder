...
<section>
  ...
  {Array.isArray(data.education) ? (
    ...
    <div className="mb-4 p-4 rounded-lg shadow-md bg-base-200 border border-gray-300 dark:border-gray-700">
      <h3 className="text-xl font-bold">{data.education?.degree?.name || 'Degree not specified'}</h3>
      <p className="text-gray-500">
        {data.education?.degree?.university || 'University not specified'}
      </p>
    </div>
  )}
</section>
        ...
        <section>
          ...
          {Array.isArray(data.projects) &&
            ...
            >
              ...
              <p className="text-gray-500">
                 🛠 Technologies: {Array.isArray(proj.technologiesUsed) ? proj.technologiesUsed.join(", ") : "Not specified"}
              </p>
